      ...
      <Container style={{ fontFamily: 'Open Sans' }}>
        ...
        <Card>
          ...
          <Card.Body>
            <Card.Text>
              <h4>Metamask</h4>
              This applications uses <a href="https://metamask.io">
                Metamask
              </a>{' '}
              a web browser extension to interact with the Ethereum blockchain.
              You can install it on firefox and chrome as well as on mobile.
              <br />
              <br />
